...
function Panel(props) {
  ...
  const handleDropDownMatrix = () => {
    setState({
      ...state,
      DropDownMatrix: !state.DropDownMatrix,
    });
  }
  ...
  const handleMatrixChange = (e) => {
    ...
    // console.log(value);
    // console.log(state.matrixRow +" " +state.matrixCol);
  ...
  return (
    <div className="Home">
      ...
      <div className="Home-main-activity">
              ...
              <div className="Panel-Section-1">
                ...
                <div className="Panel-Section-1-options">
                  ...
                  <div className="Panel-Array">
                    <button
                      id="Array-option-button"
                      onClick={handleDropDownMatrix}
                    >
                      Matrix
                    </button>
                    {state.DropDownMatrix && (
                      <div className="DropDownArray">
                        <input
                          id="DropDownArray-length"
                          type="number"
                        ...
                        <div className="DropDownArray-options">
                          <div
                            ...
                            onClick={() => {
                              // axios.post("http://localhost:8800/updateAddNewQueueType/Integer")
                              setState({ ...state, typeOfMatrix: "Integer" });
                            }}
                          >
                            Integer
                          </div>
                          <div
                            ...
                            onClick={() => {
                              // axios.post("http://localhost:8800/updateAddNewQueueType/String")
                              setState({ ...state, typeOfMatrix: "String" });
                            }}
                          >
                            String
                          </div>
                          <div
                            ...
                            onClick={() => {
                              // axios.post("http://localhost:8800/updateAddNewQueueType/Double")
                              setState({ ...state, typeOfMatrix: "Boolean" });
                            }}
                          >
                            Boolean
                          </div>
        ...
        >
          {/* {console.log(state.lengthOfArray)} */}
          {/* {console.log(state.matrixRow)}
          {console.log(state.matrixCol)} */}
          {/* {console.log(state.typeOfMatrix)} */}
          ...
          <Workspace
            ...
            typeOfMatrix={state.typeOfMatrix}
            matrixRow = {state.matrixRow}
            matrixCol = {state.matrixCol}
          />
          {/* <LinkedList/> */}
        </div>
        <div className="Notes">
